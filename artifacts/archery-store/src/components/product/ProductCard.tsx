...
import type { ProductWithRelations } from "@workspace/api-client-react";

export function ProductCard({ product }: { product: ProductWithRelations }) {
  const imageUrl = product.images?.[0]?.url || "https://images.unsplash.com/photo-1598134493179-51332e56807f?w=600&h=800&fit=crop";
