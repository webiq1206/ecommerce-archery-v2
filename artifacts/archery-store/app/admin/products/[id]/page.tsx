...
import { db, productsTable, productImagesTable, productVariantsTable, productSpecsTable, productFaqsTable, productCategoriesTable, productTagsTable, categoriesTable, brandsTable } from "@workspace/db";
