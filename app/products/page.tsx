...
import { db, productsTable, productImagesTable, brandsTable, reviewsTable, categoriesTable, productCategoriesTable, collectionsTable, productCollectionsTable } from "@/lib/db";
