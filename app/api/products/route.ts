...
import { db, productsTable, productImagesTable, brandsTable, reviewsTable, categoriesTable, productCategoriesTable } from "@/lib/db";
import { CreateProductBody } from "@/lib/api-zod";
