...
import { db, productsTable, productImagesTable, productVariantsTable, productSpecsTable, productFaqsTable, productCategoriesTable, productTagsTable, categoriesTable, brandsTable, reviewsTable } from "@/lib/db";
import { UpdateProductBody } from "@/lib/api-zod";
